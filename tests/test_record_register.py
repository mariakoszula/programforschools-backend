...
def test_record_register(contract_for_school_no_dairy, second_contract_for_school,
    ...
    add_record("15.12.2023", contract_for_school_no_dairy.id, product_store_apple)
